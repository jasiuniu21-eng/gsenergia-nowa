  ...
  return (
    ...
    >
      <div
        ...
        style={{
          animation: `k9-marquee ${duration}s linear infinite ${direction}`,
        }}
      >
...
export function LightTrust() {
  ...
  return (
    <section
      ...
      style={{
        background: "var(--k9-cream)",
        color: "var(--k9-cream-ink)",
      }}
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, rgba(22, 163, 74, 0.2), transparent 70%)",
          filter: "blur(60px)",
        }}
      />
      ...
      <div className="k9-container relative">
        ...
        >
          <p
            className="k9-mono text-[11px] tracking-[0.22em] mb-6 uppercase font-semibold"
            style={{ color: "var(--k9-accent-dim)" }}
          >
            // Zaufali nam
          </p>
          <h2
            className="k9-display text-[clamp(2rem,1rem+3vw,3.75rem)] leading-[1.02] max-w-[18ch] mx-auto"
            style={{ color: "var(--k9-cream-ink)" }}
          >
            <em className="italic" style={{ color: "var(--k9-accent-dim)" }}>
              {TOTAL_LOGOS}+
            </em>{" "}
      ...
      {reduced ? (
        ...
        <div className="k9-container grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-8 items-center">
