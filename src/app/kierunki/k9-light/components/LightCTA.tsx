...
export function LightCTA() {
  ...
  return (
    ...
    >
      ...
      <div className="k9-container relative">
        <motion.p
        ...
        <motion.h2
          ...
          className="k9-display text-[clamp(2.5rem,1.5rem+3.5vw,5.5rem)] leading-[1.02] max-w-[20ch] mx-auto"
        >
          Policzmy co możesz{" "}
          <span className="italic" style={{ color: "var(--k9-accent)" }}>
            zaoszczędzić.
          </span>
        </motion.h2>
        ...
        <motion.p
          ...
          className="mt-8 text-[17px] text-[color:var(--k9-ink-muted)] max-w-[55ch] mx-auto leading-[1.55]"
        >
        ...
        >
          <a
            href={SURVEY_URL}
            className="group inline-flex items-center gap-3 h-[56px] px-8 rounded-full text-[15px] font-medium transition-transform hover:scale-[1.02] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-4 focus-visible:ring-offset-[color:var(--k9-bg)]"
            style={{
          ...
          <span className="text-[14px] text-[color:var(--k9-ink-faint)]">
            albo zadzwoń:
          </span>
          <a
            href={SHARED.contact.phoneHref}
            className="k9-mono text-[15px] font-medium transition-colors hover:text-[color:var(--k9-accent)]"
