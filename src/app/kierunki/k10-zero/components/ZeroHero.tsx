...
/**
 * K10 Zero hero — canvas "flower bouquet" that reveals as characters
...
export function ZeroHero() {
  ...
  return (
    ...
    >
      ...
      >
        <span
          className="block k10-label mb-3.5"
          style={{
            opacity: 0,
            animation: "k10-fadeUp 0.5s 0.4s ease forwards",
          }}
        >
          Energy Intelligence
        </span>
        <h1
          className="k10-display"
          style={{
            ...
            opacity: 0,
            animation: "k10-fadeUp 0.7s 0.6s ease forwards",
          }}
        >
          Budujemy
          <br />
          <em className="not-italic" style={{ color: "var(--k10-accent)" }}>
            tanią
          </em>{" "}
          energię.
        </h1>
        <span
          ...
          style={{
            color: "var(--k10-ink-faint)",
            letterSpacing: "0.03em",
            opacity: 0,
            animation: "k10-fadeUp 0.6s 0.85s ease forwards",
          }}
        >
      ...
      <div
        ...
        style={{
          ...
          width: "min(540px, 90%)",
          opacity: 0,
          animation: "k10-fadeUp 0.5s 1.1s ease forwards",
        }}
      >
        <div
