...
/**
 * K10 Zero navigation — directly inspired by user's HTML mockup.
  ...
  return (
    <div className="relative z-50">
      ...
      <div
        ...
        style={{ background: "var(--k10-topbar)" }}
      >
        {[
          ...
          <div key={i.label} className="flex items-center gap-5">
            ...
            <a
              ...
              style={{ color: "var(--k10-topbar-ink)", letterSpacing: "0.04em" }}
              onMouseEnter={(e) => (e.currentTarget.style.color = "#fff")}
              onMouseLeave={(e) =>
                (e.currentTarget.style.color = "var(--k10-topbar-ink)")
              }
            >
              {i.label}
            </a>
      ...
      <nav
        ...
        style={{
          ...
          borderBottom: "1px solid var(--k10-line)",
      ...
      >
          ...
          >
            <span
              ...
              style={{
                ...
                animation: "k10-blink 2s infinite",
              }}
            />
            Włączam oszczędność
          </span>
        ...
        <div className="hidden md:flex items-stretch h-[66px]">
          {NAV_LINKS.map((l) => (
            <a
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.color = "var(--k10-accent)";
                e.currentTarget.style.borderBottomColor = "var(--k10-accent)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.color = "var(--k10-ink)";
        ...
        {searchOpen && (
          <div
            ...
            style={{
              background: "var(--k10-bg)",
              borderBottom: "2px solid var(--k10-accent)",
