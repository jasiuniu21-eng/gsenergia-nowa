  ...
  return (
    ...
    >
      <div
        ...
        style={{
          animation: `k10-marquee ${duration}s linear infinite ${direction}`,
        }}
      >
...
export function ZeroTrust() {
  ...
  return (
    <section
      ...
      style={{
        background: "var(--k10-cream)",
        color: "var(--k10-cream-ink)",
      }}
    >
      ...
      <div className="k10-container relative">
        ...
        >
          ...
          <h2
            className="k10-display text-[clamp(2rem,1rem+3vw,3.75rem)] leading-[1.02] max-w-[18ch] mx-auto"
            style={{ color: "var(--k10-cream-ink)" }}
          >
            <em className="italic" style={{ color: "var(--k10-accent-dim)" }}>
              {TOTAL_LOGOS}+
            </em>{" "}
      ...
      {reduced ? (
        ...
        <div className="k10-container grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-8 items-center">
