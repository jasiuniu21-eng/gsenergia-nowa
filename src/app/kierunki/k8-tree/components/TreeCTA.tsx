...
export function TreeCTA() {
  ...
  return (
    ...
    >
      ...
      <div className="k8-container relative">
        <motion.p
          initial={reduced ? false : { opacity: 0, y: 8 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, amount: 0.5 }}
          transition={{ duration: 0.6 }}
          className="k8-mono text-[11px] tracking-[0.18em] mb-10 flex items-center justify-center gap-2"
        ...
        <motion.h2
          ...
          className="k8-display text-[clamp(2.5rem,1.5rem+3.5vw,5.5rem)] leading-[1.02] max-w-[20ch] mx-auto"
        >
          Policzmy co możesz{" "}
        ...
        <motion.p
          ...
          className="mt-8 text-[17px] text-[color:var(--k8-ink-muted)] max-w-[55ch] mx-auto leading-[1.55]"
        >
        ...
        >
          <a
            href={SURVEY_URL}
            className="group inline-flex items-center gap-3 h-[56px] px-8 rounded-full text-[15px] font-medium transition-transform hover:scale-[1.02] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-4 focus-visible:ring-offset-[color:var(--k8-bg)]"
            style={{
          ...
          <span className="text-[14px] text-[color:var(--k8-ink-faint)]">
            albo zadzwoń:
          </span>
          <a
            href={SHARED.contact.phoneHref}
            className="k8-mono text-[15px] font-medium transition-colors hover:text-[color:var(--k8-accent)]"
