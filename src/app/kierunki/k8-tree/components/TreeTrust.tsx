  ...
  return (
    ...
    >
      <div
        ...
        style={{
          animation: `k8-marquee ${duration}s linear infinite ${direction}`,
        }}
      >
...
export function TreeTrust() {
  ...
  return (
    <section
      ...
      style={{
        background: "var(--k8-cream)",
        color: "var(--k8-cream-ink)",
      }}
    >
      ...
      <div className="k8-container relative">
        ...
        >
          <p
            className="k8-mono text-[11px] tracking-[0.18em] mb-6 uppercase font-semibold"
            style={{ color: "var(--k8-accent-dim)" }}
          >
            // Zaufali nam
          </p>
          <h2
            className="k8-display text-[clamp(2rem,1rem+3vw,3.75rem)] leading-[1.02] max-w-[18ch] mx-auto"
            style={{ color: "var(--k8-cream-ink)" }}
          >
            <em className="italic" style={{ color: "var(--k8-accent-dim)" }}>
              {TOTAL_LOGOS}+
            </em>{" "}
      ...
      {reduced ? (
        ...
        <div className="k8-container grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-8 items-center">
