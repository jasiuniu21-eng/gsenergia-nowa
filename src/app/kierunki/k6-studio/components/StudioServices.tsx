      ...
      <div className="k6-container">
        ...
        >
          <h2 className="k6-display text-[clamp(2.5rem,1.5rem+3vw,5rem)] leading-[1]">
            ...
            dziedzin.
            <br />
            <em className="italic" style={{ color: "var(--k6-accent)" }}>
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="group w-full text-left py-8 lg:py-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--k6-accent)] rounded-sm"
                >
                  <div className="grid grid-cols-[60px_1fr_auto] lg:grid-cols-[100px_1fr_auto] gap-6 lg:gap-12 items-baseline">
                    {/* Index */}
                    <span
                      className="k6-serif italic text-[28px] lg:text-[48px] leading-none transition-colors"
                      style={{
                        color: isOpen
                          ? "var(--k6-accent)"
                          : "var(--k6-accent-dim)",
                    ...
                    <div className="min-w-0">
                      <h3
                        className="k6-display text-[clamp(1.75rem,1rem+2vw,3rem)] leading-[1.05] transition-colors"
                        style={{
                          color: isOpen
                            ? "var(--k6-accent)"
                            : "var(--k6-ink)",
                      ...
                      {!isOpen && (
                        <p className="mt-2 text-[15px] lg:text-[17px] text-[color:var(--k6-ink-muted)] leading-[1.5] max-w-[60ch]">
                          {s.short}
                        </p>
                      )}
                    </div>
                    ...
                    >
                      <div className="grid grid-cols-1 lg:grid-cols-[100px_1fr_auto] gap-6 lg:gap-12 pb-10 lg:pb-12">
                        ...
                        <div className="max-w-[64ch]">
                          <p className="text-[16px] lg:text-[18px] text-[color:var(--k6-ink)] leading-[1.55] mb-6">
                            {s.body}
                          </p>
                          ...
                          <ul className="space-y-3 mb-8">
                            {(DETAILS[s.id] ?? []).map((d) => (
                              <li
                                key={d}
                                className="flex gap-3 text-[14px] lg:text-[15px] text-[color:var(--k6-ink-muted)] leading-[1.5]"
                              >
                                <span
                                  aria-hidden="true"
                                  className="k6-mono text-[12px] shrink-0 mt-1"
                          ...
                          <a
                            href={SURVEY_URL}
                            className="inline-flex items-center gap-2 h-11 px-5 rounded-full text-[14px] font-medium transition-transform hover:scale-[1.03] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--k6-accent)] focus-visible:ring-offset-4 focus-visible:ring-offset-[color:var(--k6-bg)]"
                            style={{
                        ...
                        <div className="flex items-start lg:justify-end">
                          ...
                          >
                            <span
                              className="k6-display text-[36px] lg:text-[44px] leading-none"
                              style={{ color: "var(--k6-accent)" }}
                            >
                              {s.metric}
                            </span>
                            <span className="k6-mono text-[10px] uppercase tracking-[0.15em] text-[color:var(--k6-ink-faint)]">
                              {s.metricLabel}
                            </span>
                          </div>
                        </div>
        ...
        <p className="mt-10 text-[13px] text-[color:var(--k6-ink-faint)] k6-mono text-center">
